...
class $AssetsImagesGen {
  ...
  final SvgGenImage bottomSplash = const SvgGenImage(
    'assets/images/bottom_splash.svg',
  );
  final SvgGenImage logo = const SvgGenImage('assets/images/logo.svg');
  final SvgGenImage pageViewItem1BackgroundImage = const SvgGenImage(
    'assets/images/page_view_item1_background_image.svg',
  );
  final SvgGenImage pageViewItem1Image = const SvgGenImage(
    'assets/images/page_view_item1_image.svg',
  );
  final SvgGenImage pageViewItem2BackgroundImage = const SvgGenImage(
    'assets/images/page_view_item2_background_image.svg',
  );
  final SvgGenImage pageViewItem2Image = const SvgGenImage(
    'assets/images/page_view_item2_image.svg',
  );
  final SvgGenImage plant = const SvgGenImage('assets/images/plant.svg');
}
